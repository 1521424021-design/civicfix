...
<head>
    ...
    <title><?= isset($title) ? $title : 'Registrasi Akun - CivicFix'; ?></title>
...
<div class="auth-flex-container">
    <div class="register-box-card animate__animated animate__zoomIn">
        
        <div class="text-center mb-4">
            <h1 class="brand-gradient-text">CivicFix</h1>
            <div class="text-muted small-caps">Registrasi Akun Warga</div>
        </div>
        ...
        <form action="<?= base_url('auth/proses_register'); ?>" method="POST">
            ...
            <div class="form-floating-group">
                <i class="bi bi-person-fill input-group-icon-box"></i>
                <input type="text" name="nama" class="custom-register-input" placeholder="Nama Lengkap..." required autocomplete="off">
            </div>

            <div class="form-floating-group">
                <i class="bi bi-card-text input-group-icon-box"></i>
                <input type="text" name="nik" class="custom-register-input" placeholder="Nomor Induk Kependudukan (NIK)..." required autocomplete="off" maxlength="16">
            </div>

            <div class="form-floating-group">
                <i class="bi bi-envelope-at-fill input-group-icon-box"></i>
                <input type="email" name="email" class="custom-register-input" placeholder="Alamat Email..." required autocomplete="off">
            </div>

            <div class="form-floating-group" style="margin-bottom: 30px;">
                <i class="bi bi-lock-fill input-group-icon-box"></i>
                <input type="password" name="password" class="custom-register-input" placeholder="Buat Kata Sandi..." required>
            </div>

            <button type="submit" class="btn btn-premium-register mb-4">
                <i class="bi bi-person-plus-fill me-2 text-warning"></i> Daftarkan Akun Baru
            </button>
            
            <div class="text-center mb-1" style="font-size: 0.85rem; font-weight: 600;">
                <span class="text-muted">Sudah punya akun?</span> 
                <a href="<?= base_url('auth'); ?>" class="text-decoration-none text-primary fw-bold ms-1">Login Di Sini</a>
            </div>
            ...
            <div class="text-center text-muted border-top pt-3 mt-4" style="font-size: 0.72rem; font-weight: 500; border-color: #f1f5f9 !important;">
                <i class="bi bi-shield-fill-check text-primary me-1"></i> Proteksi Enkripsi SQA Satgas Vokasi
            </div>
        </form>
